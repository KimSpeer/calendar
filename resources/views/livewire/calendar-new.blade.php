      ...
      <ol class="mt-4 text-sm leading-6 divide-y divide-gray-100 lg:col-span-7 xl:col-span-8">
        <li class="relative flex py-6 space-x-6 xl:static">
          ...
          <div class="absolute right-0 top-6 xl:relative xl:top-auto xl:right-auto xl:self-center">
            ...
            -->
            <div class="absolute right-0 z-10 mt-2 origin-top-right bg-white rounded-md shadow-lg focus:outline-none w-36 ring-1 ring-black ring-opacity-5" role="menu" aria-orientation="vertical" aria-labelledby="menu-0-button" tabindex="-1">
